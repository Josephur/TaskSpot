...
//END TODO
    ...
    // TaskSpot: focusable hover popup hosting the tooltip content + live search.
    readonly property Component searchPopupComponent: Qt.createComponent("SearchPopup.qml")
    property SearchPopup searchPopup

    // TaskSpot (#10): one shared plugin serves both this widget and the
    // stock task manager (package sibling via X-Plasma-RootPath). All
